...
import 'package:board_manager/ui/router/app_router.gr.dart' as _i14;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i12.CollectionRepository>(() =>
      _i12.CollectionRepository(get<_i5.GameCollectionLocalDataSource>()));
  gh.lazySingleton<_i13.UserRepository>(
      () => _i13.UserRepository(get<_i9.AuthLocalDataSource>()));
  gh.singleton<_i14.AppRouter>(autoRouteInjectableModule.router);
...
class _$AutoRouteInjectableModule extends _i15.AutoRouteInjectableModule {}
