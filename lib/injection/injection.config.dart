...
import 'package:board_manager/ui/router/app_router.gr.dart' as _i6;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.singleton<_i6.AppRouter>(autoRouteInjectableModule.router);
  await gh.singletonAsync<_i4.HiveInterface>(() => hiveInjectableModule.hive,
      preResolve: true);
  await gh.singletonAsync<_i4.Box<_i7.User>>(
      () => hiveInjectableModule.userBox(get<_i4.HiveInterface>()),
      preResolve: true);
  return get;
}

class _$AutoRouteInjectableModule extends _i8.AutoRouteInjectableModule {}
